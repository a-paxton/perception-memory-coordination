...
```{r concatenate-data, warning = FALSE, error = FALSE, message = FALSE, eval=FALSE}
...
```{r identify-dyads, warning = FALSE, error = FALSE, message = FALSE, eval=FALSE}
...
```{r process-infos, warning = FALSE, error = FALSE, message = FALSE, eval=FALSE}
...
```{r print-sanity-check-for-duplicate-issues, invisible=TRUE, echo=FALSE, eval=FALSE}
...
```{r identify-complete-dyads, eval=FALSE}
...
```{r print-usable-dyads, invisible=TRUE, echo=FALSE, eval=FALSE}
...
```{r sanity-check-for-training-and-test, eval=FALSE}
...
```{r print-problem-participants, invisible=TRUE, echo=FALSE, eval=FALSE}
...
```{r add-questionnaire-data, eval=FALSE}
...
```{r identify-questionnaire-dyads, eval=FALSE}
...
```{r print-quesionnaire-dyads, invisible=TRUE, echo=FALSE, eval=FALSE}
...
```{r create-unique-ids, eval=FALSE}
...
```{r training-improvement, eval=FALSE}
...
```{r plot-training_slopes, echo=FALSE, warning = FALSE, error = FALSE, message = FALSE, eval=FALSE}
...
```{r plot-normalized-error-over-all-trials, echo=FALSE, warning = FALSE, error = FALSE, message = FALSE, eval=FALSE}
...
```{r create-column-for-partner-guess, eval=FALSE}
...
```{r exploration-prelim, warning = FALSE, error = FALSE, message = FALSE, eval=FALSE}
...
```{r mean-experiment-duration, eval=FALSE}
...
```{r mean-time-for-all-participants, eval=FALSE}
...
```{r print-mean-time-for-all-participants, echo=FALSE, eval=FALSE}
cat('Average participation: ',mean(all_participant_time$duration),' minutes',sep='')
```

```{r mean-time-for-included-participants, eval=FALSE}
...
```{r print-mean-time-for-included-participants, echo=FALSE, eval=FALSE}
...
# grab just the questionnaire data and create a mean training improvement score
questions_only = select(winnowed_info_df, 
                        one_of(c('experiment','dyad','participant',
...
info_plot = winnowed_info_df %>% ungroup() %>%
  mutate_at(vars(one_of(questionnaire_variables)),
            funs(ordered)) %>%
