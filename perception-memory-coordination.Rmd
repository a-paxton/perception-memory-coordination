...
ggsave(plot = first_guess_error,
       height = 4,
       width = 3,
       filename = './figures/pmc-first_guess.jpg')
...
ggsave(plot = first_guess_error,
       ...
       width = 3,
       dpi=100,
       filename = './figures/pmc-first_guess-knitr.jpg')

```

![**Figure**. Density plots of questionnaire responses, normalized error, and improvement over training trials. Truncated to not display high-error guesses, using a cutoff of absolute normalized error of 0.20.](./figures/pmc-all_variables-knitr.jpg)
...
ggsave(plot = cross_corr_plot,
       height = 4,
       width = 5,
       filename = './figures/pmc-cross_corr_plot.jpg')
...
ggsave(plot = cross_corr_plot,
       ...
       width = 5,
       dpi=100,
       filename = './figures/pmc-cross_corr_plot.jpg-knitr.jpg')

```

![**Figure**. Cross-correlation of partners' normalized error across turns, overlaid with best-fit line.](./figures/pmc-cross_corr_plot.jpg-knitr.jpg)
