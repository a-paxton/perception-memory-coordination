...
Interestingly, we found that participants took more guesses on test trials when they improved more in their training trials (*\(\beta\)*=`r round(trust_model_model_readable$Estimate[training_row],2)`, *p*<`r trust_model_model_readable$"p-value"[training_row]`). Assuming that those with the greatest training improvement were the most poorly performing initial players, this suggests that poorer-performing players are more likely to divide the cognitive labor of the task and follow the lead of their higher-performing partner.
