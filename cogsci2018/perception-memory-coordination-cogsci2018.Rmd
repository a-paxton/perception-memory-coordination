...
We found that greater trust in their partner predicted an *increase* in the number of iterations of guesses within a trial (*\(\beta\)* = `r round(trust_model_model_readable$Estimate[trust_partner_row],2)`, *p* < `r trust_model_model_readable$"p-value"[trust_partner_row]`), suggesting that participants may have been more willing to change their guess to be more similar to their partner's because they trusted that person's judgement.
