...
ccf_df = ccf_df %>% ungroup() %>%	
  ...
  mutate(cooperative.both.lag_ot1 = cooperative_self * cooperative_partner * lag_ot1) %>%	
  mutate(trust_self.lag_ot1 = trust_self * lag_ot1) %>%	
  mutate(trust_partner.lag_ot1 = trust_partner * lag_ot1) %>%	
  mutate(trust.both.lag_ot1 = trust_self * trust_partner * lag_ot1) %>%	
...
write.table(info_plot, './data/study_1-neutral/info_plot.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
write.table(info_st, './data/study_1-neutral/info_st.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
	
# export standardized and plotting first-guess datasets	
write.table(first_guess_plot, './data/study_1-neutral/first_guess_plot.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
write.table(first_guess_st, './data/study_1-neutral/first_guess_st.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
	
# export standardized and plotting final-guess datasets	
write.table(final_guess_plot, './data/study_1-neutral/final_guess_plot.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
write.table(final_guess_st, './data/study_1-neutral/final_guess_st.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
	
# export standardized and plotting ccf datasets	
write.table(ccf_plot, './data/study_1-neutral/ccf_plot.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
write.table(ccf_st, './data/study_1-neutral/ccf_st.csv', sep=',',	
            append = FALSE, quote = FALSE, na = "NA", 	
            row.names = FALSE, col.names = TRUE)	
